	...
	public void advance(){	// Lee la siguiente línea y parsea sus comandos
		try {
			...
			case (3):	// Un comando con dos argumentos, String e int
				...
				// Si es un comando push o pop, pero los argumentos no son los posibles, error de sintáxis
				if ((comando == Comandos.C_PUSH || comando == Comandos.C_POP) && 
						!(arg1.equals("static") || arg1.equals("this") || 
							arg1.equals("local") || arg1.equals("argument") ||
							arg1.equals("that") || arg1.equals("constant") ||
							arg1.equals("pointer") || arg1.equals("temp"))) {
					System.err.println("Error de sintaxis");
					System.exit(0);				
				}
				
				if (arg2 < 0) {	// Si el segundo argumento es un número negativo, error de sintáxis
					System.err.println("Error de sintaxis");
					System.exit(0);
				}
				
				/* Si es un push/pop al pointer pero el argumento es mayor a 1, o es un push/pop al
				 * temp, y el argumento es mayor a 7, error de sintáxis */
				if (comando == Comandos.C_PUSH || comando == Comandos.C_POP) {
					if ((arg1.equals("pointer") && arg2 > 1) || (arg1.equals("temp") && arg2 > 7)){
						System.err.println("Error de sintaxis");
						System.exit(0);
					} 
				}
